...
namespace BNG
{
    ...
    public class Arrow : MonoBehaviour
    {
        ...
        public CalculateLocalPoint localPointCalculator;
        ...
        void Start()
        {
            ...
            localPointCalculator = FindFirstObjectByType<CalculateLocalPoint>();
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            if (!isCounted && collision.gameObject.name.ToLower().Contains("target"))
            {
                isCounted = true; // Prevent multiple counts for the same target
                hitPoint = collision.GetContact(0).point;
                if (localPointCalculator != null)
                {
                    hitPoint = localPointCalculator.GetLocalPoint(hitPoint);
                    uIManager.UpdateUI(hitPoint);
                }
                Debug.Log("Hit Point in Local Space: " + hitPoint);
            }
